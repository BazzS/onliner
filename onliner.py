...
class Locators:
    ...
    PHONES_ACCESSORIES = (By.CLASS_NAME, "catalog-navigation-list__aside-item")
    PHONES = (By.XPATH, '//*[@id="container"]/div/div/div/div/div[1]/div[3]/div/div[1]/div[1]/div/div[1]/div[2]/div/a[1]/span/span[2]')
